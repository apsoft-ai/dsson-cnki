    function 浏览框(name,event){   
        ...
        //组件命令：
        this.置尺寸 = function (w,h){
            var web = document.getElementById(this.名称);
			var height = h;
			...
			if(mui.os.ios){
				web.style.cssText="width:"+window.innerWidth+"px !important;height:"+height;
				web.scrolling="no";				
			}else{
				web.style.width = w;
				web.style.height = height;				
			}
			web.style.border="0px";
        } 
